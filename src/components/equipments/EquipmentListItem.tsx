...
const EquipmentListItem = ({ equipment }: Props) => {
  return (
    <div key={equipment.id} className="w-full max-w-md sm:max-w-xl lg:max-w-3xl mx-auto my-2">
      <div className="flex w-full items-center bg-inherit rounded shadow-sm overflow-hidden cursor-pointer hover:bg-white/5 transition-colors">
        ...
        <div className="flex grow items-center justify-between px-4 py-2">
          <h2 className="text-lg sm:text-xl lg:text-xl font-bold text-inherit">{equipment.name}</h2>
