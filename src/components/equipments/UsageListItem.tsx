            ...
            <div>
              ...
              <div className="mt-2">
                {usage.muscles.map(muscle => (
                  <span
                    key={`u${usage.id}muscle${muscle.id}`}
                    className="inline-flex items-center rounded-md bg-pink-400/10 px-2 py-1 text-xs font-medium text-pink-400 inset-ring inset-ring-pink-400/20"
                  >
                    {muscle.name}
                  </span>
                ))}
