...
export default function StepEdit({step, updateStepHandler }: StepEditProps) {
  const [editingStep, setEditingStep] = useState<Step>({
    instruction: '', medias: [], setUp: false, title: ''
  });
      ...
      <div className="mt-3">
        <div key={step.id} className="bg-gray-600 border border-gray-300 rounded-md p-3 mb-3">
          <div>
            ...
            <TextInput id="title" type="text" sizing="lg" onChange={handleChange} value={editingStep.title} />
          </div>
          <div>
            <div className="mb-2 block">
              <Label htmlFor="instruction">Instruction</Label>
            </div>
            <TextInput id="instruction" type="text" sizing="lg" onChange={handleChange} value={editingStep.instruction} />
          </div>
          <div>
            <div className="flex mt-3">
              <TextInput type="checkbox" id="setUp" className="mt-1 me-3 scale-150" checked={editingStep.setUp} onChange={handleChange}/>
